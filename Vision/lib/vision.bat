...
if "%ver%"=="install" (python C:\Vision\Vision-windows\Vision\bin\add-remove.py %ver% %app%) else (
	if "%ver%"=="uninstall" (python C:\Vision\Vision-windows\Vision\bin\add-remove.py %ver% %app%) else (
		if "%ver%"=="update" (python C:\Vision\Vision-windows\Vision\bin\add-remove.py %ver% %app%) else (
			if "%ver%"=="info" (python C:\Vision\Vision-windows\Vision\bin\add-remove.py %ver% %app%)
